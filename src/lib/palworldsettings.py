...
class SettingStructs:
    ...
    MaxBuildingLimitNum = ConfigOption("MaxBuildingLimitNum", StructTypes.Int, 0)
    ServerReplicatePawnCullDistance = ConfigOption("ServerReplicatePawnCullDistance", StructTypes.Float, 15000.000000)
    bAllowGlobalPalboxExport = ConfigOption("bAllowGlobalPalboxExport", StructTypes.Bool, True)
    bAllowGlobalPalboxImport = ConfigOption("bAllowGlobalPalboxImport", StructTypes.Bool, False)
