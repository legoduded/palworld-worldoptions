...
class SettingStructs:
    ...
    CollectionObjectRespawnSpeedRate = ConfigOption("CollectionObjectHpRate", StructTypes.Float, 1.000000)
    ...
    bEnableDefenseOtherGuildPlayer = ConfigOption("", StructTypes.Bool, False)
